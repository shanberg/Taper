const tokens = {
  ...
  "colors.bgForm": {
    "value": "#f9f9fb",
    "variable": "var(--colors-bg-form)"
  },
  "colors.bgControl": {
    "value": "#e0e8ef",
    "variable": "var(--colors-bg-control)"
  },
  "colors.status.warning": {
    "value": "#f0ad4e",
    "variable": "var(--colors-status-warning)"
  },
  "colors.status.warningContrast": {
    "value": "#fff",
    "variable": "var(--colors-status-warning-contrast)"
  },
  "colors.status.error": {
    "value": "#d9534f",
    "variable": "var(--colors-status-error)"
  },
  "colors.status.errorContrast": {
    "value": "#f2dede",
    "variable": "var(--colors-status-error-contrast)"
  },
  "colors.status.errorBgMuted": {
    "value": "rgba(210, 83, 79, 0.05)",
    "variable": "var(--colors-status-error-bg-muted)"
  },
  "shadows.xs": {
  ...
  "shadows.controlFocusVisible": {
    "value": "inset 0 0 0 1px var(--colors-fg), 0 0 0 1px var(--colors-fg)",
    "variable": "var(--shadows-control-focus-visible)"
  },
  "shadows.controlWarning": {
    "value": "inset 0 0 0 1px var(--colors-status-warning), 0 0 0 1px var(--colors-status-warning)",
    "variable": "var(--shadows-control-warning)"
  },
  "shadows.page": {
    "value": "0 0 1.5rem rgba(0, 0, 0, 0.025)",
    "variable": "var(--shadows-page)"
  },
  "radii.xs": {
    "value": "0.125rem",
  ...
  "sizes.controlHeight": {
    "value": "32px",
    "variable": "var(--sizes-control-height)"
  },
  "sizes.breakpoint-sm": {
    "value": "640px",
  ...
  "colors.colorPalette.warningContrast": {
    "value": "var(--colors-color-palette-warning-contrast)",
    "variable": "var(--colors-color-palette-warning-contrast)"
  },
  "colors.colorPalette.error": {
    "value": "var(--colors-color-palette-error)",
    "variable": "var(--colors-color-palette-error)"
  },
  "colors.colorPalette.errorContrast": {
    "value": "var(--colors-color-palette-error-contrast)",
    "variable": "var(--colors-color-palette-error-contrast)"
  },
  "colors.colorPalette.errorBgMuted": {
    "value": "var(--colors-color-palette-error-bg-muted)",
    "variable": "var(--colors-color-palette-error-bg-muted)"
  }
}
